...
public class RoundRobyn {
    ...
    public double tiempo_Espera(){
     ...
     public double TRetorno(int numero){
        ...
        for(int i=0;i<listaDoble.size()-1;i++){
         ...
         System.out.println("Tiempo Promedio Retorno es:");
         respuesta=respuesta/numero;
         return respuesta;
    }
     public double TRespuesta(int numero){
        ...
        for(int i=0;i<listaDoble.size()-1;i++){
         ...
         System.out.println("Tiempo Promedio Respuesta es:");
        respuesta=respuesta/numero;
        return respuesta;
    ...
    System.out.println(r.presentar());
           System.out.println("---");
     System.out.println(r.tiempoespera);
     System.out.println("---");
        System.out.println(r.tiempoRetorno());
     System.out.println("---");
        System.out.println(r.tiemporespuesta);
